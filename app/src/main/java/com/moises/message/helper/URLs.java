package com.moises.message.helper;

//turotial criar class @moises

public class URLs {

    public static final String ROOT_URL = "http://192.168.94.1/SimplifiedCodingChat/v1/"; // lembrar troca endereço
